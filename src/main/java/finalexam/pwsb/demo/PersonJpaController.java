 ...
 */
package finalexam.pwsb.demo;

import finalexam.pwsb.demo.exceptions.NonexistentEntityException;
import finalexam.pwsb.demo.exceptions.PreexistingEntityException;
...
public class PersonJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("finalexam.pwsb_demo_jar_0.0.1-SNAPSHOTPU");
